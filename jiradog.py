...
class jira_provider(object):
  ...
  def issue_filter(paginated_list, filter_jinja2):
    ...
    field = filter_jinja2_regex.group(2)
    fields = field.split(".")
    ...
    for page in paginated_list:
      for issue in page['issues']:
        ...
        if type(regex_result) == None:
          paginated_list[paginated_list.index(page)][page].remove(issue)
    pprint(paginated_list)
